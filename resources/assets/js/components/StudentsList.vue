                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody><!-- Aqui empiezan la lista de grupos ================================================================================= -->
                            <tr v-for="student in arrayStudent" :key="student.id">
                                ...
                                <td v-text="student.paternal_surname"></td>
                                <td v-text="student.maternal_surname"></td>
                                <td v-text="student.group_name"></td>
                                <td v-text="student.grade"></td>
                                <td>
                                        <button type="button" @click="openModal('student', 'calification', student)" class="btn btn-warning btn-sm">
